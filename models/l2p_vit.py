...
class L2PVIT(ContinualModel):
    ...
    def __init__(self, backbone, loss, args, transform):
        ...
        # set requires_grad is false for not update
        ...
        # learning|_param : list of param can update
    ...
    def init_opt(self,args):
        ...
        if args.freeze_clf == 0:
            # vô đây, tuning cả self.classifier
    ...
    def similarity(self, pool, q, k, topN):
        ...
        # pool_size x 768 = 10 x 768 = T x 768
    ...
    def getPrompts(self,pool,query):
        ...
        prompts = pTensor[selectedKeys,:,:]  # ! (B, topN, Lp, Dp) = B x 5 x 5 x 768
        prompts = prompts.reshape(B,-1,Dp)   # ! (B, topN*Lp, Dp) = B x 25 x 768
